...
public class MainActivity extends AppCompatActivity
 {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        recyclerView = findViewById(R.id.rvListProduse);
    ...
    public void saveInFile(View v)
    {
     ...
     public class AdaptorRecView extends RecyclerView.Adapter<AdaptorRecView.ViewHolder>
     {

         private List<String> produseList;
